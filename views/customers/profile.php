...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mt-6 p-4 bg-green-50 rounded-lg">
        <div class="flex items-center">
            ...
            <div>
                <h4 class="font-medium text-green-900">Telegram Connected</h4>
    ...
    <div class="mt-6 p-4 bg-blue-50 rounded-lg">
        <div class="flex items-center">
            ...
            <div>
                <h4 class="font-medium text-blue-900">Connect Telegram</h4>
                <p class="text-sm text-blue-700">
                    Link your Telegram account to create and manage tickets via chat.
                    Contact support for the bot link.
                </p>
            </div>
        </div>
    </div>
